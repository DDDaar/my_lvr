...
# export CACHE_DIR="/home/ma-user/lbx/lvr-main/training_cache"
...
# RANDOM_SEED=42
# DATA_PATH="/home/ma-user/work/lbx/dataset/lvr_viscot/meta_data_lvr_sft_stage1.json"

# ####################################7B模型，如果4卡，会oom,被迫使用8ka，其余内容不变
# ####################################zero3，8卡还oom，减小MAX_INSTANCE_PER_BATCH，但原本8卡使数据量翻倍，可尝试减半MAX_INSTANCE_PER_BATCH到2
# # General training params
# MAX_STEPS=2500
# # GLOBAL_BATCH_SIZE=256       # global_batch_size becomes irrelevant when use data packing
# BATCH_PER_DEVICE=1            # if use data packing, BS should always be 1
...
# # ONLINE=True to enable online checkpointing with OCI
# ONLINE=False
# OUTPUT_DIR="/home/ma-user/work/lbx/lvr-main/stage1_checkpoints_7b/"
...
LVR_COMPRESSOR_TYPE=qformer
LVR_QFORMER_PRETRAINED_MODEL_NAME_OR_PATH="Salesforce/blip2-opt-2.7b"

...
# # 创建一个专门的缓存文件夹,新增新增新增新增新增新增新增新增新增新增新增新增
...
# # DATA_PATH="/cache/lvr_data/meta_data_lvr_sft_stage1.json"
...
RUN_NAME="Stage1_${LVR_LOSS_FCT}LVRLossLambda${LAMBDA_LVR}-MaxVisToken${MAX_TOKEN}-MinVisToken${MIN_TOKEN}"
# ONLINE=True to enable online checkpointing with OCI
OUTPUT_DIR="/home/ma-user/work/lbx/lvr-main/stage1_checkpoints/"
